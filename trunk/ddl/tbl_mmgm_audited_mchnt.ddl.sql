...
CREATE TABLE
    ...
    (   
        ...
        CONSTRAINT IND_MMGM_AM_PK PRIMARY KEY (MCHNT_CD)
    );

--CREATE INDEX MMGM.IND_MMGM_AM_I1
--ON MMGM.TBL_MMGM_AUDITED_MCHNT (
--        MCHNT_CD
--    )
--;

GRANT ALL ON MMGM.TBL_MMGM_AUDITED_MCHNT TO USER OP_MGMAP;
GRANT SELECT ON MMGM.TBL_MMGM_AUDITED_MCHNT TO USER OP_MGMMN;
