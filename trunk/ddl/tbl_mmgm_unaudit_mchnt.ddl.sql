...
CREATE TABLE
    ...
    (   
        ...
        CONSTRAINT IND_MMGM_UM_PK PRIMARY KEY (MCHNT_CD)
    );

--CREATE INDEX MMGM.IND_MMGM_UN_I1
--ON MMGM.TBL_MMGM_UNAUDIT_MCHNT (
--        MCHNT_CD
--    )
--;

GRANT ALL ON MMGM.TBL_MMGM_UNAUDIT_MCHNT TO USER OP_MGMAP;
GRANT SELECT ON MMGM.TBL_MMGM_UNAUDIT_MCHNT TO USER OP_MGMMN;
